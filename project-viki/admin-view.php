...
• Template for header icons.
• Use PerfectScroller?
• Keep Material Icons?


NOTES: This PEN needs manual customization for icons to work properly. I've not included it here, as each icon may have it's own unique dropdown, link, modal or window etc.
...
*/
    ...
    (min-resolution: 192dpi) {
        .be-top-header .be-navbar-header .navbar-brand {
            background-image: url("https://res.cloudinary.com/studiokonkon/image/upload/v1544030389/website/konkon-header-300x76-ova-pwhite.png");
    ...
    @media (max-width: 767.98px) {
        .be-top-header .be-right-navbar {
            ...
            -ms-flex-pack: justify;
            justify-content: space-between;
            border-bottom: 1px solid #FE669E;
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
    ...
    .be-left-sidebar .sidebar-elements .divider:before {
        content: "";
        display: block;
        padding: 0;
        margin: 8px auto;
    ...
    .be-left-sidebar .sidebar-elements li.parent>a:hover:before {
        color: #fe6ba1;
    }
    ...
    .be-offcanvas-menu .be-left-sidebar .sidebar-elements>li ul {
        background-color: #fff4f8;
    }
...
-->
    <div class="be-wrapper be-offcanvas-menu be-fixed-sidebar">
        <nav class="navbar navbar-expand fixed-top be-top-header">
            <div class="container-fluid">
               ...
               <em class="sidebar-line"></em>
            </a>
                    <a class="navbar-brand" href="#"></a>
                </div>
                <div class="be-right-navbar be-right-navbar-flex pull-right">


                    <ul class="nav navbar-nav float-right be-icons-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#">Signout</a>
                        </li>
    ...
    <script>
        $(document.body).addClass("be-animate be-offcanvas-menu open-left-sidebar");

        $("#sidebar_btn").on("click", function() {
            $(document.body).toggleClass('open-left-sidebar');
        });

        // TODO: improve open/closing of submenus
        $(".sidebar-elements .parent > a").on("click", function(evt) {
            $this = $(this).parent();
            $(".sidebar-elements .parent").not($this).removeClass("open");
